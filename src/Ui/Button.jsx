...
function Button({children,disabled,to,type,onClick}) {
    ...
    const base =  `bg-yellow-400 text-sm rounded-full uppercase font-semibold 
    ...
    const styles ={
        ...
        secondary: `px-4 py-2.5 text-sm md:px-6 md:py-3.5  rounded-full uppercase font-semibold 
